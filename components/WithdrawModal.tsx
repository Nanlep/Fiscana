...
interface WithdrawModalProps {
    isOpen: boolean;
    onClose: () => void;
    onWithdraw: (amount: number, narration: string, category: ExpenseCategoryType) => void;
    balanceNGN: number;
}

const WithdrawModal: React.FC<WithdrawModalProps> = ({ isOpen, onClose, onWithdraw, balanceNGN }) => {
    const currency = 'NGN';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            onWithdraw(val, narration, withdrawalType);
            setStep('SUCCESS');
                ...
                {step === 'SUCCESS' && (
                    <div className="flex flex-col items-center justify-center py-8 text-center animate-in zoom-in">
                        ...
                        <p className="text-slate-500 mb-6">
                            ₦{parseFloat(amount).toLocaleString()} has been sent. <br />
