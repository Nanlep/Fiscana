                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-sm text-left">
                        <thead className="bg-slate-50 border-b border-slate-100 text-slate-500 uppercase font-semibold text-xs">
                            <tr>
                                <th className="px-3 py-3 md:px-6 md:py-4">Category</th>
                                <th className="px-3 py-3 md:px-6 md:py-4 text-right">Budgeted</th>
                                <th className="px-3 py-3 md:px-6 md:py-4 text-right">Actual</th>
                                <th className="hidden md:table-cell px-6 py-4 text-right">Variance</th>
                                <th className="hidden md:table-cell px-6 py-4 text-center">% Used</th>
                                <th className="px-3 py-3 md:px-6 md:py-4 text-center">Status</th>
                                <th className="hidden md:table-cell px-6 py-4 text-center print:hidden">Action</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100">
                            {activeBudgets.map((budget) => {
                                ...
                                return (
                                    <tr key={budget.id} className="hover:bg-slate-50/50 transition-colors">
                                        <td className="px-3 py-3 md:px-6 md:py-4 font-medium text-slate-900 text-xs md:text-sm">{budget.category}</td>
                                        <td className="px-3 py-3 md:px-6 md:py-4 text-right font-mono text-slate-600 text-xs md:text-sm">{formatCurrency(normalizedLimit, 'NGN')}</td>
                                        <td className="px-3 py-3 md:px-6 md:py-4 text-right font-mono text-slate-900 text-xs md:text-sm">{formatCurrency(spent, 'NGN')}</td>
                                        <td className={`hidden md:table-cell px-6 py-4 text-right font-mono font-bold ${variance >= 0 ? 'text-green-600' : 'text-red-500'}`}>
                                        ...
                                        <td className="hidden md:table-cell px-6 py-4 text-center print:hidden">
                                            <button
                            ...
                            {activeBudgets.length === 0 && (
                                <tr>
                                    <td colSpan={7} className="px-3 py-8 md:px-6 md:py-12 text-center text-slate-400">
                        ...
                        <tfoot className="bg-slate-50 border-t border-slate-200 font-bold">
                            <tr>
                                <td className="px-3 py-3 md:px-6 md:py-4 text-xs md:text-sm">TOTALS</td>
                                <td className="px-3 py-3 md:px-6 md:py-4 text-right font-mono text-xs md:text-sm">{formatCurrency(totalBudgeted, 'NGN')}</td>
                                <td className="px-3 py-3 md:px-6 md:py-4 text-right font-mono text-xs md:text-sm">{formatCurrency(totalSpent, 'NGN')}</td>
                                <td className={`hidden md:table-cell px-6 py-4 text-right font-mono ${totalVariance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
