...
const Reports: React.FC<ReportsProps> = ({ transactions, assets, liabilities, companyName, exchangeRate }) => {
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 print:p-0">
            ...
            {/* Paper Container */}
            <div className="bg-white p-4 md:p-12 shadow-lg border border-slate-100 rounded-xl min-h-[800px] max-w-none md:max-w-4xl md:mx-auto print:shadow-none print:border-0 print:w-full print:p-0">
                ...
                <div className="text-center mb-6 md:mb-12 border-b border-slate-900 pb-4 md:pb-8">
                    ...
                    <h3 className="text-base md:text-xl font-medium text-slate-600">
                ...
                {/* Disclaimer & Footer */}
                <div className="mt-10 md:mt-20 pt-8 border-t border-slate-200">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-end mt-8 md:mt-12 gap-8">
                        <div className="text-center w-full md:w-auto">
                            <div className="w-full md:w-48 border-b border-slate-300 mb-2"></div>
